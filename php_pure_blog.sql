...
INSERT INTO `article_tags` (`id`, `tag_id`, `article_id`, `user_id`) VALUES
(399, 12, 203, 1);
...
CREATE TABLE `categories` (
  ...
  `user_id` bigint(20) UNSIGNED DEFAULT NULL,
  `articles_count` bigint(20) UNSIGNED NOT NULL DEFAULT 0,
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
  `updated_at` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `categories` (`id`, `name`, `slug`, `icon`, `user_id`, `articles_count`, `created_at`, `updated_at`) VALUES
(120, 'javascript', 'جاوا-اسکریپت', '', 1, 0, '2024-10-09 20:15:00', '2024-10-09 20:19:36');
...
INSERT INTO `date` (`id`, `created_at`, `update_at`) VALUES
(1, '2024-10-05', '2024-10-06'),
(2, '2024-10-01', '2024-10-24'),
(3, '2024-10-25', NULL),
(4, '2024-10-24', NULL),
(5, '2024-10-29', NULL);
...
INSERT INTO `page_titles` (`id`, `script_name`, `title`) VALUES
(1, '/index.php', 'صفحه اصلی'),
(2, '/login.php', 'ورود به پنل کاربری'),
(3, '/dashboard/index.php', 'پنل کاربری'),
(4, '/dashboard/category/index.php', 'لیست دسته بندی ها'),
(5, '/dashboard/category/create.php', 'ایجاد دسته بندی جدید'),
(6, '/dashboard/category/edit.php', 'ویرایش دسته بندی'),
(7, '/dashboard/article/index.php', 'لیست مقاله ها'),
(8, '/dashboard/article/create.php', 'ایجاد مقاله جدید'),
(9, '/dashboard/tag/index.php', 'لیست تگ ها'),
(10, '/dashboard/tag/edit.php', 'ویرایش تگ '),
(11, '/dashboard/tag/create.php', 'ایجاد تگ جدید'),
(12, '/dashboard/article/edit.php', 'ویرایش مقاله');
...
CREATE TABLE `settings` (
  ...
  `favicon` varchar(60) DEFAULT NULL,
  `logo` varchar(60) DEFAULT NULL,
  `h1` varchar(60) DEFAULT NULL,
  `h2` varchar(60) DEFAULT NULL,
  `hero_image` varchar(60) DEFAULT NULL,
  `article_default_thumbnail` varchar(60) NOT NULL,
  `user_default_thumbnail` varchar(60) NOT NULL,
  `copyright` varchar(128) DEFAULT NULL,
  `show_category_count` bigint(20) UNSIGNED DEFAULT NULL,
  `show_article_count` bigint(20) UNSIGNED NOT NULL,
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
  `updated_at` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `settings` (`id`, `title`, `favicon`, `logo`, `h1`, `h2`, `hero_image`, `article_default_thumbnail`, `user_default_thumbnail`, `copyright`, `show_category_count`, `show_article_count`, `created_at`, `updated_at`) VALUES
(1, 'وبلاگ محمد رضا شمس', 'img/home.png', 'img/logo.png', 'محمد رضا شمس', 'برنامه نویس و توسعه دهنده فول استک ', 'img/bgtop.jpg', 'img/broken-image.png', 'img/user-fallback-image.png', '\n\nتمامی حقوق متعلق به محمد رضا شمس میباشد و هرگونه کپی برداری پیگرد قانونی دارد\n', 7, 5, '2024-09-30 15:34:41', NULL);
...
CREATE TABLE `tags` (
  ...
  `user_id` bigint(20) UNSIGNED DEFAULT NULL,
  `article_count` bigint(20) UNSIGNED NOT NULL DEFAULT 0,
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
  `updated_at` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tags` (`id`, `name`, `slug`, `user_id`, `article_count`, `created_at`, `updated_at`) VALUES
(2, 'laravel', 'laravel', 1, 0, '2024-10-05 07:08:34', NULL),
(3, 'وردپرس', 'وردپرس', 1, 0, '2024-10-05 07:08:34', NULL),
(4, 'طراحی وب', 'طراحی-وب', 1, 0, '2024-10-05 07:08:34', NULL),
(5, 'برنامه نویسی', 'برنامه-نویسی', 2, 0, '2024-10-05 07:08:34', NULL),
(6, 'programming', 'programming', 1, 0, '2024-10-05 07:08:34', NULL),
(7, 'wordpress', 'wordpress', 2, 0, '2024-10-05 07:08:34', NULL),
(8, 'web design', 'web-design', 1, 0, '2024-10-05 07:08:34', NULL),
(9, 'framework', 'framework', 1, 0, '2024-10-05 07:08:34', NULL),
(10, 'backend', 'backend', 2, 0, '2024-10-05 07:08:34', NULL),
(11, 'بک اند', 'بک-اند', 1, 0, '2024-10-05 07:08:34', NULL),
(12, 'frontend', 'frontend', 2, 0, '2024-10-05 07:08:34', '2024-10-05 15:55:12'),
(13, 'فرانت اند', 'فرانت-اند', 1, 0, '2024-10-05 07:08:34', NULL),
(14, 'angular', 'angular', 1, 0, '2024-10-05 07:08:34', NULL),
(15, 'انگولار', 'انگولار', 2, 0, '2024-10-05 07:08:30', '2024-10-05 08:10:33'),
(16, 'php', 'php', 2, 0, '2024-10-05 07:08:34', NULL),
(17, 'پی اچ پی', 'پی-اچ-پی', 1, 0, '2024-10-05 07:08:34', '2024-10-05 07:44:12'),
(18, 'react', 'react', 1, 0, '2024-10-05 07:08:34', NULL),
(19, 'ریکت', 'ریکت', 1, 0, '2024-10-05 08:56:38', '2024-10-05 13:30:05'),
(20, 'ویو', 'ویو', 1, 0, '2024-10-05 07:08:59', NULL),
(21, 'javascript', 'javascript', 1, 0, '2024-10-05 07:08:34', NULL),
(22, 'جاوااسکریپت', '', 2, 0, '2020-12-12 09:01:16', '2024-10-05 13:18:09'),
(45, 'لاراول', 'لاراول', 1, 0, '2024-10-05 15:54:02', '2024-10-07 14:19:16');
...
INSERT INTO `users` (`id`, `name`, `username`, `email`, `password`, `thumbnail`, `created_at`, `updated_at`) VALUES
(1, 'محمد رضا شمس', 'admin', 'nerdpanda@gmail.com', '$2y$10$Xuq6Xkt7zhiVr6r1ZmC/FeylqRLf1umts3NMRf7ImBm0S07nQkCo2', 'img/user-1.png', '2024-09-30 07:34:12', NULL),
(2, 'Ali Reza', 'alireza', 'alireza@yahoo.com', '7709e1d3153faf1eeeff474a80e4ff7bf2be6e97', NULL, '2024-09-30 07:34:12', NULL),
(3, 'عباس', 'abas', 'abas@hotmail.com', 'fb45519bfd86140bf21e06c2676c295f783a518b', 'img/user-3.jpeg', '2024-09-30 07:34:12', '2024-09-30 07:34:12');
...
ALTER TABLE `users`
  ...
  ADD KEY `name` (`name`,`username`,`email`);
...
ALTER TABLE `article_tags`
  ...
  ADD CONSTRAINT `article_tags_ibfk_3` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Constraints for table `categories`
--
ALTER TABLE `categories`
  ADD CONSTRAINT `categories_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
--
ALTER TABLE `tags`
  ADD CONSTRAINT `tags_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
COMMIT;
